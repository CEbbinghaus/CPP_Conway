...
public:
	...
	void getCameraExtents(float& outLeft, float& outBottom, float& outRight, float& outTop);

	int addVertex(float x, float y, float z, unsigned int texture);
